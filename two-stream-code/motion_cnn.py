...
def main():
    ...
    model = Motion_CNN(
                        ...
                        lr=arg.lr,
                        batch_size=arg.batch_size,
                        channel = 10*2,                       #spatial does not have
...
class Motion_CNN():
    def __init__(self, nb_epochs, lr, batch_size, resume, start_epoch, evaluate, train_loader, test_loader, channel,test_video):
        ...
        self.best_prec1=0
        self.channel=channel    #spatial does not have
        self.test_video=test_video

    def build_model(self):
        print ('==> Build model and setup loss and optimizer')
        #build model
        self.model = resnet101(pretrained= True, channel=self.channel).cuda()  #spatial does not have
        #print self.model
    ...
    def train_1epoch(self):
        ...
        #    print data    #[torch.FloatTensor of size 10x20x224x224]
        #    print label    #[torch.LongTensor of size 10]
            ...
            input_var = Variable(data).cuda()  #spatial does not have
    ...
    def validate_1epoch(self):
        ...
        #    print keys  #('HorseRiding_g01_c01', 'CricketShot_g02_c01',...,'SkateBoarding_g03_c02')
        #    print data  #[torch.FloatTensor of size 10x20x224x224]
        #    print label #[torch.LongTensor of size 10]
            ...
            for j in range(nb_data):
                videoName = keys[j].split('-',1)[0] # ApplyMakeup_g01_c01          #spatial does not have
            #    print keys[j]     #HorseRiding_g01_c01
            #    print videoName   #HorseRiding_g01_c01
    ...
    #    print video_level_labels.shape  #(3783,)
        ...
        ii=0
        for key in sorted(self.dic_video_level_preds.keys()):        #spatial does not have
            name = key.split('-',1)[0]                               #spatial does not have
